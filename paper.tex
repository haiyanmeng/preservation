...
\begin{figure}
\centering
\includegraphics[width=1\columnwidth]{git-syscall.eps}
...
\begin{figure}
\centering
\includegraphics[width=1\columnwidth]{http_packet.eps}
...
\begin{figure}
\centering
\includegraphics[width=1\columnwidth]{url_redirection.eps}
