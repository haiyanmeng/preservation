...
\titlerunning{A Case Study in Preserving a High Energy Physics Application}
...
of existing software and systems and the resulting implicit dependencies, resource distribution, and shifting compatibility of systems---all conspiring
