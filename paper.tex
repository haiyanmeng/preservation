...
{\bf What is the Granularity of Dependencies?}  Dependencies could be handled
...
{\bf What is the Scope of Reuse?}  We have presented the data preservation
...
{\bf How to Detect Dependencies?}  If we allow users to work in uncontrolled
