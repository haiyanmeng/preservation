...
\cite{agosti2012envisage} aimed to help non-domain users to utilize the digital archive system developed for domain experts.
\cite{schoneberg2013scalable} proposed a scalable, distributed and dynamic workflow system for digitization processes.
\cite{subotic2013distributed} proposed a distributed archival network for process-oriented automatic long-term digital preservation.
...
\cite{borgman2012data} tried to figure out what types of data are most likely to be used and reused, by whom, and for what purposes through two cases studies.
