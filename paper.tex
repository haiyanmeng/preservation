...
only need to know how many items one directory contains and not need the content of the sub-dirctories or the sub-files.
Our solution is to
...
\begin{table}
    ...
    Obtain filename list & N/A & 28min 23s \\ \hline
