...
HDFS filesystem with 11.6TB of data, but only 20GB are actually consumed by the program. The CMSSW repository is 88.1GB in total
...
To do it, the application was repeated with the help of Original Script (as shown in Figure~\ref{fig:version-evolution}) on the original machine, mentioned as {\bf Original-Script} in the following part, 
one reduced package was generated and verified with the help of Parrot on the original machine, which will be mentioned as {\bf Reduced-Package}.
