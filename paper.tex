...
top quarks.  As the Higgs boson is too short-lived to be detected
...
\begin{figure}
\centering
\epsfig{file=dependencies.eps, height=3in, width=3.5in}
...
\begin{figure}
\centering
\epsfig{file=data-code-size.eps, height=3in, width=3.5in}
...
\begin{figure*}
\centering
\epsfig{file=version-evolution.eps, height=4in, width=6.5in}
