...
original author. In this application, the machine used for the application is one
...
Then one self-contained package containing all the accessed files is generated to help others repeat the application.
